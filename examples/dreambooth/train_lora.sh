...
export INSTANCE_DIR="/media/glory/46845c74-37f7-48d7-8b72-e63c83fa4f68/Style_Transfer/custom-diffusion_develop/data/cat/"
...
accelerate launch train_dreambooth_lora.py \
  ...
  --lr_warmup_steps=0 \
  --max_train_steps=500 \
  --validation_prompt="A photo of sks cat urinating" \
  --validation_epochs=50 \
  --seed="87" \
  --mixed_precision="fp16" \
  --use_8bit_adam
